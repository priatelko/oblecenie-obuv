 ...
 * @ORM\Entity
 */
class OblecenieZapinanie implements \App\Interfaces\ToStringInterface, \App\Interfaces\ToArrayObjectInterface
{
    /**
     * @var string
     *
     ...
     *
     * @ORM\ManyToMany(targetEntity="App\Entity\Oblecenie", mappedBy="oblecenieZapinanie")
     */
    private $oblecenie;
