...
export class SelectOptionDirective implements OnInit {
  ...
  @Input('appSelectOption') appSelectOption: object;
  ...
  buildOption() {
    this.el.nativeElement.innerHTML = this.getText(this.appSelectOption);
    this.el.nativeElement.setAttribute('value', this.getValue(this.appSelectOption));
  }
