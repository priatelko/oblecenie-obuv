...
export class ApiRequestService {
  ...
  get<T>(
    ...
    return this.apiResultFlashMessage<T>(
      this.http.get<T>(GLOBAL.url + endPoint, options)
    );
  }
  ...
  post<T>(
    ...
    return this.apiResultFlashMessage<T>(
      this.http.post<T>(GLOBAL.url + endPoint, params, options)
    );
  }
  ...
  put<T>(
    ...
    options = this.defaultOptions(options);
    return this.apiResultFlashMessage<T>(
      this.http.put<T>(GLOBAL.url + endPoint, params, options)
    );
  }
  ...
  delete<T>(
    ...
    options = this.defaultOptions(options);
    return this.apiResultFlashMessage<T>(
      this.http.delete<T>(GLOBAL.url + endPoint, options)
    );
  }
