 ...
 * DressStyle
 *
 * @ORM\Table(name="dress_style")
 * @ORM\Entity
 */
class DressStyle implements \App\Interfaces\ToStringInterface, \App\Interfaces\ToArrayObjectInterface
{
    /**
     * @var string
     *
     ...
     *
     * @ORM\ManyToMany(targetEntity="App\Entity\Dress", mappedBy="dressStyle")
     */
    private $dress;
