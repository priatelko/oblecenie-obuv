 ...
 * @ORM\Entity
 */
class OblecenieStyl implements \App\Interfaces\ToStringInterface, \App\Interfaces\ToArrayObjectInterface
{
    /**
     * @var string
     *
     ...
     *
     * @ORM\ManyToMany(targetEntity="App\Entity\Oblecenie", mappedBy="oblecenieStyl")
     */
    private $oblecenie;
