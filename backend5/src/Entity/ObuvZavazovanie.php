...
class ObuvZavazovanie
{
     ...
     *
     * @ORM\ManyToMany(targetEntity="App\Entity\Obuv", mappedBy="obuvZavazovanie")
     */
    private $obuv;
     ...
     * Add obuv
     *
     * @param \App\Entity\Obuv $obuv
     *
     * @return ObuvZavazovanie
     */
    public function addObuv(\App\Entity\Obuv $obuv)
    {
        $this->obuv[] = $obuv;
     ...
     * @param \App\Entity\Obuv $obuv
     */
    public function removeObuv(\App\Entity\Obuv $obuv)
    {
